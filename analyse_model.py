...
folder_savepath = 'trained_models/high_fixed_normalized_2/weight_scale_' + str(v1_weight_scale).replace('.', '') + '_001_' + str(v4_weight_scale).replace('.', '') #path to existing directory for saving trained models
...
difference = False
plt.subplot(3, 3, 1)
net.plot_v1_tuning_curve(orientation = 3, phi_sf = 0, position = int((net.v1_dimensions - 1) / 2), orientations = True, differences = difference);
