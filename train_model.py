...
paramdict= {'precision_hard' : precision_hard, 'precision_easy':precision_easy, 'v1_weight_scalar': v1_weight_scale, 'phase_weight_scalar': phase_weight_scale, 'v4_weight_scalar': v4_weight_scale, 'learning_rate':learning_rate, 'train_iters':iterations, 'input_size':inp_size, 'v1_size':v1_size, 'v1_orientation_number':v1_orientation_number, 'v4_size':v4_size, 'v4_stride':v4_stride, 'v4_orientation_number':v4_orientation_number, 'phis':phis, 'training_size':training_size, 'random_sf':random_sf, 'v1_gamma': v1_gamma, 'v4_orientation_std': v4_orientation_std}
